...
import { Contact2, LocationEditIcon, BoxIcon, ArrowRightIcon } from "lucide-react";
    ...
    <div className="p-2 overflow-hidden md:p-0">
      ...
      >
        ...
        <div className="flex flex-col gap-3 p-3">
          ...
          <p className="text-blue-600 w-60">
            {t('Reliable and Affordable Shipping Services To Give You the Peace Of mind You Deserve')}
          </p>
          <Link to={'/register'} className="bg-blue-600 text-white p-2 rounded-b-sm rounded-e-xs font-extrabold w-44 text-center">
            {t('Sign Up Today')}
          </Link>
        </div>
      </div>
      ...
      <div className="bg-blue-700 text-white p-8 flex flex-col gap-10">
        <h2 className="text-white font-extrabold w-72 md:w-dvh text-4xl">
          {t('Shipping To & From Any Country Should Be More Reliable')}
        </h2>
        ...
        <Link to={'/register'} className="bg-white text-blue-600 p-2 rounded-b-sm rounded-e-xs font-extrabold w-44 text-center">
          {t('Sign Up Today')}
        </Link>
      ...
      <div className="bg-blue-950">
        ...
        <div className="lg:flex col p-10 gap-10 overflow-x-scroll overscroll-x-contain md:flex-row">
